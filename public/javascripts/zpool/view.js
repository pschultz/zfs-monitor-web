...
define(['zpool/caption-view', 'diskarray/view', 'iostats/view', 'scan/view', 'zfs/filesystem-view'], function(ZPoolCaptionView, DiskArrayView, IostatsView, ScanView, FilesystemView) {
  var ZPoolView;
  ZPoolView = (function(_super) {
    ...
    function ZPoolView() {
      ...
      this.renderIostats = __bind(this.renderIostats, this);
